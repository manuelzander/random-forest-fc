...
-- Remove the trigger that auto-updated badges since we'll handle this differently
DROP TRIGGER IF EXISTS trigger_update_player_badges ON players;
DROP FUNCTION IF EXISTS update_player_badges();