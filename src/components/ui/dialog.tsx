...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 pt-2 sm:flex-row sm:justify-end sm:items-center",
      className
    )}
    {...props}
  />
